...
document.addEventListener('DOMContentLoaded',()=>{const savedTheme=localStorage.getItem('resumeTheme')||'blue';changeTheme(savedTheme);const savedDarkMode=localStorage.getItem('resumeDarkMode')==='false';if(savedDarkMode){document.documentElement.classList.add('dark')}
